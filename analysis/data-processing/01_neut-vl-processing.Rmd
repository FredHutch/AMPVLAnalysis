...
The engineered time variables are extracted for each participant to be saved separately as a meta dataset.

```{r create-time-data}
# pull out infection time data
ptid_time_data = final_vl_data %>%
  select(pub_id, infection_pre85wks, has_neut_data, 
