...
# loads rx_dat
#source(here("data-raw/unblind-loc.R"))
rx_dat = read_csv(here("data-raw/rx_dat.csv"))
rx_lab = tibble(
  rx_code2 = c("C", "T1", "T2"),
...
neut_data = read_csv(mlx_data_here("clean_source/amp-neut-blinded.csv"), col_types = cols())
vl_data = read_csv(mlx_data_here("clean_source/vl_data.csv"), col_types = cols()) %>%
