...
```{r protocol-pool, fig.width = 4}

pl_protocol$plot + theme(legend.position = "bottom")

```


```{r ic80-pool, fig.width = 4}
...
```{r fp-protocol-pool, fig.width = 4}

fp_pl_protocol$plot + theme(legend.position = "bottom")

```


```{r fp-ic80-pool, fig.width = 4}
